Asset Creator - Vladislav Horobets (aka ErbGameArt).
-----------------------------------------------------
If you want the same glowing as on the video - just use free Post-processing stack from Unity Technologies
...
1.3)Always use custom data to flap butterflies wings at different times (see the "Render" tab and "Custom Data" tab)
